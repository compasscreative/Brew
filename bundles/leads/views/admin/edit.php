    ...
    <div class="body">
        <form autocomplete="off" id="leads_lead_edit">
            ...
            <ul>
                ...
                <?php } ?>
                <?php if (strlen($this->lead->address)) { ?>
                    <li>
                        <div class="label">
                            <label>Address:</label>
                        </div>
                ...
                <?php } ?>
                <?php if (strlen($this->lead->interest)) { ?>
                    <li>
                        <div class="label">
                ...
                <?php } ?>
                <?php if (strlen($this->lead->budget)) { ?>
                    <li>
                        <div class="label">
                ...
                <?php } ?>
                <?php if (strlen($this->lead->referral)) { ?>
                    <li>
                        <div class="label">
