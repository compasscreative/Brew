...
$.router('/admin/blog/article/add', function()
{
    var form = $('form');
...
$.router('/admin/blog/article/edit/[0-9]+', function()
{
    var form = $('form');
...
$.router('/admin/blog/category/add', function()
{
    var form = $('form');
...
$.router('/admin/blog/category/edit/[0-9]+', function()
{
    var form = $('form');
